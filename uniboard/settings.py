...
TwoFA_SecretKey = env('TwoFA_SecretKey')
...
SECRET_KEY = "django-insecure-r7l(3uws)ve@^6x5o46$ncv5+rfu=f#8i$@a4*2v%(iz&+piql"
...
CORS_ALLOW_HEADERS = ['Content-Type', 'Authorization', 'deviceid']
